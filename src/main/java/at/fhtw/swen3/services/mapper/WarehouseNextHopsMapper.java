...
public interface WarehouseNextHopsMapper {
    ...
    WarehouseNextHops entityToDto(WarehouseNextHopsEnitity warehouseNextHopsEnitity);

    WarehouseNextHopsEnitity dtoToEntity(WarehouseNextHops warehouseNextHops);
}
