...
public class TrackingInformationDtoMapper {
    @Test
    void entityToDto() {
        ...
        TrackingInformationDto trackingInformationDto = at.fhtw.swen3.services.mapper.TrackingInformationDtoMapper.INSTANCE.entityToDto(parcelEntity);

        assertEquals(trackingInformationDto.getState().toString(),parcelEntity.getState().toString());
        assertEquals(trackingInformationDto.getFutureHops().get(1).getCode(),futureHops.get(1).getCode());
